...
if __name__ == "__main__": 
    ...
    save_plot_line_graphs(epoch_train_acc, epoch_test_acc, filename='figs/p1_acc.png', plot_type='acc')
    save_plot_line_graphs(epoch_train_loss, epoch_test_loss, filename='figs/p1_loss.png', plot_type='loss')
